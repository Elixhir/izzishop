...
from src.domain.use_cases.get_all_stores import GetAllStoresUseCase
...
def get_all_stores_use_case() -> GetAllStoresUseCase:
    store_repository = get_store_repository()
    return GetAllStoresUseCase(store_repository)
